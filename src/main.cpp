...
int main(int argc, char** argv){
    ...
    std::cout << "\tSets Generated:  " << float_ms.count() << " milliseconds" << std::endl;
    

    printSizes(sizes, dataOutput);

    bool dataValidity = checkData(insertionSortDataGen, quickSortDataGen, heapSortDataGen, dataOutput, sizes);
